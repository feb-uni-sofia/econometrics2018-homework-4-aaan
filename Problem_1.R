...
## This means that the null hypothesis states that women's work hours
## increase the average population work hours
...
## i)
## The test assumes that the population follows a t-distribution, 
##however our expectations are that the
